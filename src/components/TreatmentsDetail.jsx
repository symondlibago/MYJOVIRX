...
function Cta({ label }) {
  return (
    <a
      ...
      className="group inline-flex items-center justify-center gap-3 rounded-sm bg-ink px-8 py-3.5 text-[10px] uppercase tracking-[0.3em] text-ivory transition-colors duration-500 hover:bg-ink-warm"
    >
      {label}
